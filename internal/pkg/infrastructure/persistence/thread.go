...
func NewThread(db *pgx.ConnPool) *ThreadDB {
...
func (threadDB *ThreadDB) InsertInto(thread *models.Thread) error {
	tx, err := threadDB.db.Begin()
	if err != nil {
		return err
	}
...
func (threadDB *ThreadDB) GetBySlug(thread *models.Thread) error {
	tx, err := threadDB.db.Begin()
	if err != nil {
		return err
	}
...
func (threadDB *ThreadDB) GetById(thread *models.Thread) error {
	tx, err := threadDB.db.Begin()
	if err != nil {
		return err
	}
...
func (threadDB *ThreadDB) GetBySlugOrId(thread *models.Thread) error {
	tx, err := threadDB.db.Begin()
	if err != nil {
		return err
	}
...
func (threadDB *ThreadDB) InsertIntoVotes(thread *models.Thread, vote *models.Vote) error {
	tx, err := threadDB.db.Begin()
	if err != nil {
		return err
	}
...
func (threadDB *ThreadDB) Update(thread *models.Thread) error {
	tx, err := threadDB.db.Begin()
	if err != nil {
		return err
	}
...
func (threadDB *ThreadDB) GetPosts(thread *models.Thread, desc, sort, limit, since string) ([]models.Post, error) {
	tx, err := threadDB.db.Begin()
	if err != nil {
		return nil, err
	}
